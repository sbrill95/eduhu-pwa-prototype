...
export const PROMPT_TEMPLATES: PromptTemplate[] = [
  // Quiz Templates
  {
    ...
    promptTemplate:
      'Erstelle ein Quiz für {{fach}}, {{klassenstufe}}. Klasse zum Thema {{topic}}. Das Quiz soll 10 Fragen enthalten mit Multiple Choice Antworten.',
    category: 'quiz',
  ...
  },
  {
    ...
    promptTemplate:
      'Erstelle ein herausforderndes Quiz für {{fach}}, {{klassenstufe}}. Klasse zum Thema {{topic}}. Das Quiz soll 15 Fragen mit unterschiedlichen Schwierigkeitsgraden enthalten.',
    category: 'quiz',
    icon: 'trophyOutline',
    color: '#FB6542',
  ...
  },
  {
    ...
    promptTemplate:
      'Erstelle ein spielerisches und motivierendes Quiz für {{fach}}, {{klassenstufe}}. Klasse. Nutze kreative Fragestellungen und beziehe Alltagsbezüge ein.',
    category: 'quiz',
  ...
  // Worksheet Templates
  {
    ...
    promptTemplate:
      'Erstelle ein Arbeitsblatt mit Übungsaufgaben für {{fach}}, {{klassenstufe}}. Klasse. Schwierigkeitsgrad: mittel. Format: PDF-ready mit klarer Struktur.',
    category: 'worksheet',
  ...
  },
  {
    ...
    promptTemplate:
      'Erstelle ein differenziertes Arbeitsblatt für {{fach}}, {{klassenstufe}}. Klasse mit drei Schwierigkeitsstufen (leicht, mittel, schwer). Thema: {{topic}}.',
    category: 'worksheet',
    icon: 'layersOutline',
    color: '#FFBB00',
  ...
  // Lesson Plan Templates
  {
    ...
    promptTemplate:
      'Erstelle einen Unterrichtsplan für {{fach}}, {{klassenstufe}}. Klasse, Dauer: 45 Minuten. Thema: {{topic}}. Inklusive: Einstieg, Erarbeitung, Sicherung.',
  ...
  },
  {
    ...
    promptTemplate:
      'Erstelle einen detaillierten Unterrichtsplan für eine Doppelstunde (90 Min) in {{fach}}, {{klassenstufe}}. Klasse. Thema: {{topic}}. Berücksichtige Methodenvielfalt und Sozialformen.',
    category: 'lesson-plan',
    icon: 'timeOutline',
    color: '#9C27B0',
  ...
  // Image Generation Templates
  {
    ...
    promptTemplate:
      'Erstelle ein illustratives Bild für {{fach}}-Unterricht, {{klassenstufe}}. Klasse zum Thema {{topic}}. Stil: pädagogisch, klar, ansprechend, kindgerecht.',
    category: 'image',
    icon: 'imageOutline',
    color: '#4CAF50',
  ...
  },
  {
    ...
    promptTemplate:
      'Erstelle ein übersichtliches Diagramm oder Schaubild für {{fach}}, {{klassenstufe}}. Klasse zum Thema {{topic}}. Klare Beschriftungen, gut lesbar.',
    category: 'image',
  ...
  // Web Search Templates
  {
    ...
    promptTemplate:
      'Suche im Web nach aktuellen Unterrichtsmaterialien für {{fach}}, {{klassenstufe}}. Klasse zum Thema {{topic}}. Fokus auf frei verfügbare und qualitativ hochwertige Ressourcen.',
    category: 'search',
    icon: 'searchOutline',
    color: '#2196F3',
    estimatedTime: '1-2 Minuten',
  ...
  // Explanation Templates
  {
    ...
    promptTemplate:
      'Erkläre {{topic}} für {{klassenstufe}}. Klasse im Fach {{fach}}. Nutze einfache Sprache, anschauliche Beispiele und Alltagsbezüge.',
  ...
  },
  {
    ...
    promptTemplate:
      'Erstelle eine Schritt-für-Schritt Erklärung für {{topic}} im Fach {{fach}}, {{klassenstufe}}. Klasse. Strukturiere die Erklärung in klare, nachvollziehbare Schritte.',
    category: 'explanation',
    icon: 'listOutline',
    color: '#FF9800',
    estimatedTime: '2-3 Minuten',
  ...
  // Other Templates
  {
    ...
    promptTemplate:
      'Erstelle eine sinnvolle Hausaufgabe für {{fach}}, {{klassenstufe}}. Klasse zum Thema {{topic}}. Zeitaufwand: ca. 20-30 Minuten.',
    category: 'other',
    icon: 'homeOutline',
    color: '#607D8B',
    estimatedTime: '2-3 Minuten',
  ...
  },
  {
    ...
    promptTemplate:
      'Erstelle transparente Bewertungskriterien für eine Aufgabe in {{fach}}, {{klassenstufe}}. Klasse zum Thema {{topic}}. Nutze ein Punktesystem.',
    category: 'other',
